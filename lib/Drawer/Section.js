...
export default class Section extends Component {
    ...
    renderRow = (item, index, color) => {
        return (
            <View
                key={index}
                style={[styles.item, {marginRight: 30}]}
            >
                
                <View style={styles.value}>
                    <Text style={[TYPO.paperFontBody2, { color }, styles.valueText]}>
                        {item.value}
                    </Text>
                </View>
				{item.icon &&
            ...
            <View style={styles.section}>
                {title &&
                    <View style={[styles.subheader, styles.item]}>
                        <Text style={[TYPO.paperFontBody2, { color: SUB_TEXT_COLOR }, styles.titleText]}>
                            {title}
                        </Text>
                    </View>
                }
